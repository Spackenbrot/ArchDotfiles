...
--
myNormalBorderColor  = "#a83299"
myFocusedBorderColor = "#32a852"
...
myManageHook = composeAll
    ...
    , className =? "MEGAsync"       --> hasBorder False
...
myCurrentWSColor = myFocusedBorderColor  -- color of active workspace
myVisibleWSColor = myNormalBorderColor  -- color of inactive workspace
...
main = do
  xmproc0 <- spawnPipe "xmobar -x 0 /home/shenakiii/.config/xmobar/xmobarrc"
  xmproc1 <- spawnPipe "xmobar -x 1 ~/.config/xmobar/xmobarrc"
  xmonad $ docks defaults {
    logHook = dynamicLogWithPP myPP { ppOutput = hPutStrLn xmproc0 }
           >> dynamicLogWithPP myPP { ppOutput = hPutStrLn xmproc1 }
    }
